    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          Row(
            children: [
              bloquesPortada("p1.jpg", "Única temporada: ", "15/02/2007"),
              SizedBox(
                width: widthpantalla * .03,
              ),
              bloquesPortada("p2.jpg", "Pelicula Naruto Shippūden: ", "4/08/2007"),
              SizedBox(
                width: widthpantalla * .03,
              ),
              bloquesPortada("p3.jpg", "Primer Ova: ", "2003")
            ],
          ),
          const Divider(
            thickness: 1,
          ...
          bloquePersonajes("Sasuke Uchiha",  0xff4913C4, "o1"),
          bloquePersonajes("Naruto Uzumaki",0xffF82A2D, "o2"),
          bloquePersonajes("Jiraiya", 0xff21E295, "o3"),
          bloquePersonajes("Itachi Uchiha", 0xffFE4649, "o4"),
          bloquePersonajes("Sakura Haruno", 0xffDF1C6A, "o5"),
          bloquePersonajes("Kakashi Hatake", 0xff21E295, "o6"),
        ],
      ),
    );
  }
